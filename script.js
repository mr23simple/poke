document.addEventListener('DOMContentLoaded', () => {
    fetch('PGSStats.json')
        ...
        .catch(error => {
            ...
            document.body.innerHTML = `<p style="color:red; text-align:center;">Could not load PGSStats.json. Make sure the file is in the same directory and you are using a local server.</p>`;
        });
});
